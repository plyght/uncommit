      ...
      <div className="w-full max-w-[520px] text-left">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-2">
            ...
            <ol className="ml-5 list-decimal text-[0.8125rem] leading-loose opacity-80">
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-[0.6875rem] font-medium uppercase tracking-[0.05em] opacity-50">Security</h2>
            <p className="text-[0.8125rem] leading-relaxed opacity-80">
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-[0.6875rem] font-medium uppercase tracking-[0.05em] opacity-50">Source</h2>
            <p className="text-[0.8125rem] leading-relaxed opacity-80">
              <a 
          ...
          <Link href="/" className="text-[0.75rem] opacity-50 transition-opacity hover:opacity-100">&larr; Back</Link>
        </div>
      </div>
    </main>
  );
